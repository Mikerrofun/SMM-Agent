 ...
 *  - статичная часть: тематическая карта канала + задача (в <untrusted_source>);
...
ЗАДАЧА:
Вот главные идеи канала Натальи. Выбери тему, которую стоит дораскрыть, или пробел, которого не хватает в канале.
Создай пост для Telegram-канала Натальи: дораскрой существующую тему с нового ракурса или закрой найденный пробел.
</untrusted_source>`;
